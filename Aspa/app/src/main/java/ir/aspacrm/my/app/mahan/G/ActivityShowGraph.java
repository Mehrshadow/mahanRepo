...
import ir.aspacrm.my.app.mahan.G.events.EventOnGetErrorGetGraph;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetGraphResponse;
import ir.aspacrm.my.app.mahan.G.model.Graph;
...
public class ActivityShowGraph extends AppCompatActivity {
    ...
    @Bind(ir.aspacrm.my.app.mahan.G.R.id.chart1) HorizontalBarChart mChart;
    ...
    @Bind(ir.aspacrm.my.app.mahan.G.R.id.layLoading) LinearLayout layLoading;
    Graph graph;
