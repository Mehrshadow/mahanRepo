...
import ir.aspacrm.my.app.mahan.G.classes.CheckNotification;
...
//    public static final long NOTIFICATION_CHECKER_TIME = 30 * 1000;
    ...
    public void onCreate() {
        ...
        /** get customerId */
        customerId = getResources().getInteger(ir.aspacrm.my.app.mahan.R.integer.customer_id);
//        if(customerId != 0)
...
//        }
        ...
        Logger.d("G : values folder is " + getResources().getString(ir.aspacrm.my.app.mahan.R.string.values_folder));
