...
import ir.aspacrm.my.app.mahan.G.adapter.AdapterConnection;
import ir.aspacrm.my.app.mahan.G.classes.Logger;
import ir.aspacrm.my.app.mahan.G.classes.WebService;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetConnectionResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetErrorGetConnections;
...
public class ActivityShowConnections extends AppCompatActivity{
    ...
    @Bind(ir.aspacrm.my.app.mahan.R.id.lstConnection) RecyclerView lstConnection;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(ir.aspacrm.my.app.mahan.R.layout.activity_show_connections);
