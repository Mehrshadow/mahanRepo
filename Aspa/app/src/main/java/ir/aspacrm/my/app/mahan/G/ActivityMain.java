...
import ir.aspacrm.my.app.mahan.G.classes.Downloader;
...
import ir.aspacrm.my.app.mahan.G.enums.EnumDownloadID;
import ir.aspacrm.my.app.mahan.G.enums.EnumInternetErrorType;
import ir.aspacrm.my.app.mahan.G.events.EventOnCanceledDialogUpdatingApplication;
import ir.aspacrm.my.app.mahan.G.events.EventOnChangedDownloadPercent;
import ir.aspacrm.my.app.mahan.G.events.EventOnCheckGetPollRequest;
import ir.aspacrm.my.app.mahan.G.events.EventOnClickedLogoutButton;
import ir.aspacrm.my.app.mahan.G.events.EventOnDownloadedFileCompleted;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetErrorGetIspInfo;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetErrorGetNews;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetErrorGetNotifies;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetErrorGetUserAccountInfo;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetErrorRegConnect;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetErrorSetPoll;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetErrorUserLicense;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetIspInfoResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetNewsResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetNotifiesResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetPollResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetRegConnectionResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetStartFactorResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetUpdateResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetUserAccountInfoResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetUserLicenseResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnNoAccessServerResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnSendPollRequest;
import ir.aspacrm.my.app.mahan.G.events.EventOnSetPollResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnShowDialogUpdatingApplicationRequest;
import ir.aspacrm.my.app.mahan.G.gson.GetIspInfoResponse;
import ir.aspacrm.my.app.mahan.G.model.Account;
import ir.aspacrm.my.app.mahan.G.model.License;
import ir.aspacrm.my.app.mahan.G.model.News;
import ir.aspacrm.my.app.mahan.G.model.Notify;
...
public class ActivityMain extends AppCompatActivity implements OnClickListener {
    ...
    @Bind(ir.aspacrm.my.app.mahan.R.id.progressTraffic) ProgressWheel progressTraffic;
    @Bind(ir.aspacrm.my.app.mahan.R.id.progressDays) ProgressWheel progressDays;
    @Bind(ir.aspacrm.my.app.mahan.R.id.imgLogout) ImageView imgLogout;
    @Bind(ir.aspacrm.my.app.mahan.R.id.imgChangePassword) ImageView imgChangePassword;
    @Bind(ir.aspacrm.my.app.mahan.R.id.imgUserInfo) ImageView imgUserInfo;
    @Bind(ir.aspacrm.my.app.mahan.R.id.imgNews) ImageView imgNews;
    @Bind(ir.aspacrm.my.app.mahan.R.id.imgNotification) ImageView imgNotification;
    @Bind(ir.aspacrm.my.app.mahan.R.id.imgCompanyInfo) ImageView imgCompanyInfo;
    @Bind(ir.aspacrm.my.app.mahan.R.id.imgFeshfeshe) ImageView imgFeshfeshe;
    @Bind(ir.aspacrm.my.app.mahan.R.id.imgClub) ImageView imgClub;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layPackageName) FrameLayout layPackageName;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layGroupName) FrameLayout layGroupName;
    @Bind(ir.aspacrm.my.app.mahan.R.id.txtRemainTraffic) TextView txtRemainTraffic;
    @Bind(ir.aspacrm.my.app.mahan.R.id.txtRemainDay) TextView txtRemainDay;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layPardakhtha) LinearLayout layPardakhtha;
    @Bind(ir.aspacrm.my.app.mahan.R.id.laySuratHesab) LinearLayout laySuratHesab;
    @Bind(ir.aspacrm.my.app.mahan.R.id.laySavabeghEtesal) LinearLayout laySavabeghEtesal;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layTicket) LinearLayout layTicket;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layNemudarMasraf) LinearLayout layNemudarMasraf;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layChargeOnline) LinearLayout layChargeOnline;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layFeshfesheBashgah) LinearLayout layFeshfesheBashgah;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layUnSeenNews) LinearLayout layUnSeenNews;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layUnSeenNotify) LinearLayout layUnSeenNotify;
    @Bind(ir.aspacrm.my.app.mahan.R.id.txtUnSeenNews) TextView txtUnSeenNews;
    @Bind(ir.aspacrm.my.app.mahan.R.id.txtUnSeenNotify) TextView txtUnSeenNotify;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layBtnVaslMovaghat) CardView layBtnVaslMovaghat;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layLoading) LinearLayout layLoading;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layAccountInfo) LinearLayout layAccountInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtPackageName = (TextView) layPackageName.findViewById(ir.aspacrm.my.app.mahan.R.id.txtValue);
        txtGroupName = (TextView) layGroupName.findViewById(ir.aspacrm.my.app.mahan.R.id.txtValue);
...
//        }
    ...
    public void onClick(final View view) {
        Animation clickAnimation = AnimationUtils.loadAnimation(this, ir.aspacrm.my.app.mahan.R.anim.anim_click);
        clickAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                switch (view.getId()) {
                    case ir.aspacrm.my.app.mahan.R.id.imgLogout:
                        DialogClass dialogExit = new DialogClass();
                        dialogExit.showExitDialog();
                        break;
                    case ir.aspacrm.my.app.mahan.R.id.imgChangePassword:
                        if(G.currentLicense != null){
                        ...
                        break;
                    case ir.aspacrm.my.app.mahan.R.id.layPardakhtha:
                        startActivity(new Intent(G.context, ActivityPayments.class));
                        break;
                    case ir.aspacrm.my.app.mahan.R.id.laySuratHesab:
                        startActivity(new Intent(G.context, ActivityShowFactors.class));
                        break;
                    case ir.aspacrm.my.app.mahan.R.id.laySavabeghEtesal:
                        startActivity(new Intent(G.context, ActivityShowConnections.class));
                        break;
                    case ir.aspacrm.my.app.mahan.R.id.layTicket:
                        if(G.currentLicense != null){
                        ...
                        break;
                    case ir.aspacrm.my.app.mahan.R.id.layNemudarMasraf:
                        startActivity(new Intent(G.context, ActivityShowGraph.class));
                        break;
                    case ir.aspacrm.my.app.mahan.R.id.layChargeOnline:
                        if(G.currentLicense !=null){
