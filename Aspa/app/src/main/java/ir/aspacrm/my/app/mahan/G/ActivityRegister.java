...
import ir.aspacrm.my.app.mahan.G.adapter.AdapterSpinnerCity;
import ir.aspacrm.my.app.mahan.G.adapter.AdapterSpinnerCityGroups;
import ir.aspacrm.my.app.mahan.G.classes.DialogClass;
import ir.aspacrm.my.app.mahan.G.classes.Logger;
import ir.aspacrm.my.app.mahan.G.classes.PersianDate;
import ir.aspacrm.my.app.mahan.G.classes.WebService;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetCityGroupsResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetCityResponse;
import ir.aspacrm.my.app.mahan.G.events.EventOnGetRegisterCustomerResponse;
...
public class ActivityRegister extends AppCompatActivity {
    @Bind(ir.aspacrm.my.app.mahan.R.id.edtName) EditText edtName;
    @Bind(ir.aspacrm.my.app.mahan.R.id.edtFamily) EditText edtFamily;
    @Bind(ir.aspacrm.my.app.mahan.R.id.edtTarikhTavalod) EditText edtTarikhTavalod;
    @Bind(ir.aspacrm.my.app.mahan.R.id.edtCodeMelli) EditText edtCodeMelli;
    @Bind(ir.aspacrm.my.app.mahan.R.id.edtMobile) EditText edtMobile;
    @Bind(ir.aspacrm.my.app.mahan.R.id.edtPhone) EditText edtPhone;
    @Bind(ir.aspacrm.my.app.mahan.R.id.spCity) AppCompatSpinner spCity;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layCitySpinner) LinearLayout layCitySpinner;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layLoading) LinearLayout layLoading;
    @Bind(ir.aspacrm.my.app.mahan.R.id.spCityGroup) AppCompatSpinner spCityGroup;
    @Bind(ir.aspacrm.my.app.mahan.R.id.layCityGroupSpinner) LinearLayout layCityGroupSpinner;
    @Bind(ir.aspacrm.my.app.mahan.R.id.edtAddress) EditText edtAddress;
    @Bind(ir.aspacrm.my.app.mahan.R.id.edtUsername) EditText edtUsername;
    @Bind(ir.aspacrm.my.app.mahan.R.id.edtPassword) EditText edtPassword;
    ...
    @Bind(ir.aspacrm.my.app.mahan.R.id.txtValue) TextView txtBtnRegister;
    @Bind(ir.aspacrm.my.app.mahan.R.id.txtBack) TextView txtBack;


    AdapterSpinnerCity adapterSpinnerCity;
    AdapterSpinnerCityGroups adapterSpinnerCityGroups;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(ir.aspacrm.my.app.mahan.R.layout.activity_register);
        ...
        adapterSpinnerCityGroups = new AdapterSpinnerCityGroups(cityGroups);
